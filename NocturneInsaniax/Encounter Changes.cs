    ...
    internal partial class NocturneInsaniax : MelonMod
    {
        ...
        private class nbInitMainProcessPatch
        {
            public static void Prefix(ref int encpackno, ref int packno, ref int packindex, ref int encno, ref int stagemajor, ref int stageminor)
            {
                ...
                else if (encpackno <= 216 && evtMoon.evtGetAgeOfMoon() == 0 && datEncount.tbl[encno].btlsound == 0 && random.Next(2) == 0)
                {
        ...
        private static void ApplyEncounterChanges()
        {
            ...
            datEncountPack.divTbls[2][48].enctable[0].ritu[0].ritu = 100;
            datEncountPack.divTbls[2][48].enctable[0].ritu[1].ritu = 100;
            datEncountPack.divTbls[2][48].enctable[0].ritu[2].ritu = 100;
            datEncountPack.divTbls[2][48].enctable[0].ritu[3].ritu = 100;
            datEncountPack.divTbls[2][48].enctable[0].ritu[4].ritu = 100;
            datEncountPack.divTbls[2][48].enctable[0].ritu[5].ritu = 100;
            datEncountPack.divTbls[2][48].enctable[0].ritu[6].ritu = 79;
            datEncountPack.divTbls[2][48].enctable[0].ritu[7].ritu = 79;
            datEncountPack.divTbls[2][48].enctable[0].ritu[8].ritu = 79;
            datEncountPack.divTbls[2][48].enctable[0].ritu[9].ritu = 79;
            datEncountPack.divTbls[2][48].enctable[0].ritu[10].ritu = 79;
            datEncountPack.divTbls[2][48].enctable[0].ritu[11].ritu = 5;
            datEncountPack.divTbls[2][48].enctable[1].ritu[0].ritu = 100;
            datEncountPack.divTbls[2][48].enctable[1].ritu[1].ritu = 100;
            datEncountPack.divTbls[2][48].enctable[1].ritu[2].ritu = 100;
            datEncountPack.divTbls[2][48].enctable[1].ritu[3].ritu = 100;
            datEncountPack.divTbls[2][48].enctable[1].ritu[4].ritu = 100;
            datEncountPack.divTbls[2][48].enctable[1].ritu[5].ritu = 100;
            datEncountPack.divTbls[2][48].enctable[1].ritu[6].ritu = 79;
            datEncountPack.divTbls[2][48].enctable[1].ritu[7].ritu = 79;
            datEncountPack.divTbls[2][48].enctable[1].ritu[8].ritu = 79;
            datEncountPack.divTbls[2][48].enctable[1].ritu[9].ritu = 79;
            datEncountPack.divTbls[2][48].enctable[1].ritu[10].ritu = 79;
            datEncountPack.divTbls[2][48].enctable[1].ritu[11].ritu = 5;

            datEncountPack.divTbls[2][49].enctable[0].ritu[0].ritu = 100;
            datEncountPack.divTbls[2][49].enctable[0].ritu[1].ritu = 100;
            datEncountPack.divTbls[2][49].enctable[0].ritu[2].ritu = 100;
            datEncountPack.divTbls[2][49].enctable[0].ritu[3].ritu = 100;
            datEncountPack.divTbls[2][49].enctable[0].ritu[4].ritu = 100;
            datEncountPack.divTbls[2][49].enctable[0].ritu[5].ritu = 100;
            datEncountPack.divTbls[2][49].enctable[0].ritu[6].ritu = 79;
            datEncountPack.divTbls[2][49].enctable[0].ritu[7].ritu = 79;
            datEncountPack.divTbls[2][49].enctable[0].ritu[8].ritu = 79;
            datEncountPack.divTbls[2][49].enctable[0].ritu[9].ritu = 79;
            datEncountPack.divTbls[2][49].enctable[0].ritu[10].ritu = 79;
            datEncountPack.divTbls[2][49].enctable[0].ritu[11].ritu = 5;
            datEncountPack.divTbls[2][49].enctable[1].ritu[0].ritu = 100;
            datEncountPack.divTbls[2][49].enctable[1].ritu[1].ritu = 100;
            datEncountPack.divTbls[2][49].enctable[1].ritu[2].ritu = 100;
            datEncountPack.divTbls[2][49].enctable[1].ritu[3].ritu = 100;
            datEncountPack.divTbls[2][49].enctable[1].ritu[4].ritu = 100;
            datEncountPack.divTbls[2][49].enctable[1].ritu[5].ritu = 100;
            datEncountPack.divTbls[2][49].enctable[1].ritu[6].ritu = 79;
            datEncountPack.divTbls[2][49].enctable[1].ritu[7].ritu = 79;
            datEncountPack.divTbls[2][49].enctable[1].ritu[8].ritu = 79;
            datEncountPack.divTbls[2][49].enctable[1].ritu[9].ritu = 79;
            datEncountPack.divTbls[2][49].enctable[1].ritu[10].ritu = 79;
            datEncountPack.divTbls[2][49].enctable[1].ritu[11].ritu = 5;

            datEncountPack.divTbls[2][50].enctable[0].ritu[0].ritu = 100;
            datEncountPack.divTbls[2][50].enctable[0].ritu[1].ritu = 100;
            datEncountPack.divTbls[2][50].enctable[0].ritu[2].ritu = 100;
            datEncountPack.divTbls[2][50].enctable[0].ritu[3].ritu = 100;
            datEncountPack.divTbls[2][50].enctable[0].ritu[4].ritu = 100;
            datEncountPack.divTbls[2][50].enctable[0].ritu[5].ritu = 100;
            datEncountPack.divTbls[2][50].enctable[0].ritu[6].ritu = 79;
            datEncountPack.divTbls[2][50].enctable[0].ritu[7].ritu = 79;
            datEncountPack.divTbls[2][50].enctable[0].ritu[8].ritu = 79;
            datEncountPack.divTbls[2][50].enctable[0].ritu[9].ritu = 79;
            datEncountPack.divTbls[2][50].enctable[0].ritu[10].ritu = 79;
            datEncountPack.divTbls[2][50].enctable[0].ritu[11].ritu = 5;
            datEncountPack.divTbls[2][50].enctable[1].ritu[0].ritu = 100;
            datEncountPack.divTbls[2][50].enctable[1].ritu[1].ritu = 100;
            datEncountPack.divTbls[2][50].enctable[1].ritu[2].ritu = 100;
            datEncountPack.divTbls[2][50].enctable[1].ritu[3].ritu = 100;
            datEncountPack.divTbls[2][50].enctable[1].ritu[4].ritu = 100;
            datEncountPack.divTbls[2][50].enctable[1].ritu[5].ritu = 100;
            datEncountPack.divTbls[2][50].enctable[1].ritu[6].ritu = 79;
            datEncountPack.divTbls[2][50].enctable[1].ritu[7].ritu = 79;
            datEncountPack.divTbls[2][50].enctable[1].ritu[8].ritu = 79;
            datEncountPack.divTbls[2][50].enctable[1].ritu[9].ritu = 79;
            datEncountPack.divTbls[2][50].enctable[1].ritu[10].ritu = 79;
            datEncountPack.divTbls[2][50].enctable[1].ritu[11].ritu = 5;

            datEncountPack.divTbls[2][57].enctable[1].ritu[8].encountid = 339;

            datEncountPack.divTbls[2][58].enctable[1].ritu[8].encountid = 339;

            datEncountPack.divTbls[2][59].enctable[0].ritu[0].ritu = 100;
            datEncountPack.divTbls[2][59].enctable[0].ritu[1].ritu = 100;
            datEncountPack.divTbls[2][59].enctable[0].ritu[2].ritu = 100;
            datEncountPack.divTbls[2][59].enctable[0].ritu[3].ritu = 100;
            datEncountPack.divTbls[2][59].enctable[0].ritu[4].ritu = 100;
            datEncountPack.divTbls[2][59].enctable[0].ritu[5].ritu = 100;
            datEncountPack.divTbls[2][59].enctable[0].ritu[6].ritu = 79;
            datEncountPack.divTbls[2][59].enctable[0].ritu[7].ritu = 79;
            datEncountPack.divTbls[2][59].enctable[0].ritu[8].ritu = 79;
            datEncountPack.divTbls[2][59].enctable[0].ritu[9].ritu = 79;
            datEncountPack.divTbls[2][59].enctable[0].ritu[10].ritu = 79;
            datEncountPack.divTbls[2][59].enctable[0].ritu[11].ritu = 5;
            datEncountPack.divTbls[2][59].enctable[1].ritu[0].ritu = 100;
            datEncountPack.divTbls[2][59].enctable[1].ritu[1].ritu = 100;
            datEncountPack.divTbls[2][59].enctable[1].ritu[2].ritu = 100;
            datEncountPack.divTbls[2][59].enctable[1].ritu[3].ritu = 100;
            datEncountPack.divTbls[2][59].enctable[1].ritu[4].ritu = 100;
            datEncountPack.divTbls[2][59].enctable[1].ritu[5].ritu = 100;
            datEncountPack.divTbls[2][59].enctable[1].ritu[6].ritu = 79;
            datEncountPack.divTbls[2][59].enctable[1].ritu[7].ritu = 79;
            datEncountPack.divTbls[2][59].enctable[1].ritu[8].ritu = 79;
            datEncountPack.divTbls[2][59].enctable[1].ritu[9].ritu = 79;
            datEncountPack.divTbls[2][59].enctable[1].ritu[10].ritu = 79;
            datEncountPack.divTbls[2][59].enctable[1].ritu[11].ritu = 5;

            datEncountPack.divTbls[2][60].enctable[0].ritu[0].ritu = 100;
            datEncountPack.divTbls[2][60].enctable[0].ritu[1].ritu = 100;
            datEncountPack.divTbls[2][60].enctable[0].ritu[2].ritu = 100;
            datEncountPack.divTbls[2][60].enctable[0].ritu[3].ritu = 100;
            datEncountPack.divTbls[2][60].enctable[0].ritu[4].ritu = 100;
            datEncountPack.divTbls[2][60].enctable[0].ritu[5].ritu = 100;
            datEncountPack.divTbls[2][60].enctable[0].ritu[6].ritu = 79;
            datEncountPack.divTbls[2][60].enctable[0].ritu[7].ritu = 79;
            datEncountPack.divTbls[2][60].enctable[0].ritu[8].ritu = 79;
            datEncountPack.divTbls[2][60].enctable[0].ritu[9].ritu = 79;
            datEncountPack.divTbls[2][60].enctable[0].ritu[10].ritu = 79;
            datEncountPack.divTbls[2][60].enctable[0].ritu[11].ritu = 5;
            datEncountPack.divTbls[2][60].enctable[1].ritu[0].ritu = 100;
            datEncountPack.divTbls[2][60].enctable[1].ritu[1].ritu = 100;
            datEncountPack.divTbls[2][60].enctable[1].ritu[2].ritu = 100;
            datEncountPack.divTbls[2][60].enctable[1].ritu[3].ritu = 100;
            datEncountPack.divTbls[2][60].enctable[1].ritu[4].ritu = 100;
            datEncountPack.divTbls[2][60].enctable[1].ritu[5].ritu = 100;
            datEncountPack.divTbls[2][60].enctable[1].ritu[6].ritu = 79;
            datEncountPack.divTbls[2][60].enctable[1].ritu[7].ritu = 79;
            datEncountPack.divTbls[2][60].enctable[1].ritu[8].ritu = 79;
            datEncountPack.divTbls[2][60].enctable[1].ritu[9].ritu = 79;
            datEncountPack.divTbls[2][60].enctable[1].ritu[10].ritu = 79;
            datEncountPack.divTbls[2][60].enctable[1].ritu[11].ritu = 5;

            datEncountPack.divTbls[2][61].enctable[0].ritu[0].ritu = 100;
            datEncountPack.divTbls[2][61].enctable[0].ritu[1].ritu = 100;
            datEncountPack.divTbls[2][61].enctable[0].ritu[2].ritu = 100;
            datEncountPack.divTbls[2][61].enctable[0].ritu[3].ritu = 100;
            datEncountPack.divTbls[2][61].enctable[0].ritu[4].ritu = 100;
            datEncountPack.divTbls[2][61].enctable[0].ritu[5].ritu = 100;
            datEncountPack.divTbls[2][61].enctable[0].ritu[6].ritu = 79;
            datEncountPack.divTbls[2][61].enctable[0].ritu[7].ritu = 79;
            datEncountPack.divTbls[2][61].enctable[0].ritu[8].ritu = 79;
            datEncountPack.divTbls[2][61].enctable[0].ritu[9].ritu = 79;
            datEncountPack.divTbls[2][61].enctable[0].ritu[10].ritu = 79;
            datEncountPack.divTbls[2][61].enctable[0].ritu[11].ritu = 5;
            datEncountPack.divTbls[2][61].enctable[1].ritu[0].ritu = 100;
            datEncountPack.divTbls[2][61].enctable[1].ritu[1].ritu = 100;
            datEncountPack.divTbls[2][61].enctable[1].ritu[2].ritu = 100;
            datEncountPack.divTbls[2][61].enctable[1].ritu[3].ritu = 100;
            datEncountPack.divTbls[2][61].enctable[1].ritu[4].ritu = 100;
            datEncountPack.divTbls[2][61].enctable[1].ritu[5].ritu = 100;
            datEncountPack.divTbls[2][61].enctable[1].ritu[6].ritu = 79;
            datEncountPack.divTbls[2][61].enctable[1].ritu[7].ritu = 79;
            datEncountPack.divTbls[2][61].enctable[1].ritu[8].ritu = 79;
            datEncountPack.divTbls[2][61].enctable[1].ritu[9].ritu = 79;
            datEncountPack.divTbls[2][61].enctable[1].ritu[10].ritu = 79;
            datEncountPack.divTbls[2][61].enctable[1].ritu[11].ritu = 5;

            datEncountPack.divTbls[2][62].enctable[0].ritu[0].ritu = 100;
            datEncountPack.divTbls[2][62].enctable[0].ritu[1].ritu = 100;
            datEncountPack.divTbls[2][62].enctable[0].ritu[2].ritu = 100;
            datEncountPack.divTbls[2][62].enctable[0].ritu[3].ritu = 100;
            datEncountPack.divTbls[2][62].enctable[0].ritu[4].ritu = 100;
            datEncountPack.divTbls[2][62].enctable[0].ritu[5].ritu = 100;
            datEncountPack.divTbls[2][62].enctable[0].ritu[6].ritu = 79;
            datEncountPack.divTbls[2][62].enctable[0].ritu[7].ritu = 79;
            datEncountPack.divTbls[2][62].enctable[0].ritu[8].ritu = 79;
            datEncountPack.divTbls[2][62].enctable[0].ritu[9].ritu = 79;
            datEncountPack.divTbls[2][62].enctable[0].ritu[10].ritu = 79;
            datEncountPack.divTbls[2][62].enctable[0].ritu[11].ritu = 5;
            datEncountPack.divTbls[2][62].enctable[1].ritu[0].ritu = 100;
            datEncountPack.divTbls[2][62].enctable[1].ritu[1].ritu = 100;
            datEncountPack.divTbls[2][62].enctable[1].ritu[2].ritu = 100;
            datEncountPack.divTbls[2][62].enctable[1].ritu[3].ritu = 100;
            datEncountPack.divTbls[2][62].enctable[1].ritu[4].ritu = 100;
            datEncountPack.divTbls[2][62].enctable[1].ritu[5].ritu = 100;
            datEncountPack.divTbls[2][62].enctable[1].ritu[6].ritu = 79;
            datEncountPack.divTbls[2][62].enctable[1].ritu[7].ritu = 79;
            datEncountPack.divTbls[2][62].enctable[1].ritu[8].ritu = 79;
            datEncountPack.divTbls[2][62].enctable[1].ritu[9].ritu = 79;
            datEncountPack.divTbls[2][62].enctable[1].ritu[10].ritu = 79;
            datEncountPack.divTbls[2][62].enctable[1].ritu[11].ritu = 5;
